    ...
    Partial Public Class UtilizadoresTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Utilizadores] WHERE (([Id] = @Original_Id) AND ([Username] = @"& _ 
                "Original_Username) AND ([password] = @Original_password) AND ([nome] = @Original"& _ 
                "_nome) AND ([apelido] = @Original_apelido))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Utilizadores] ([Username], [password], [nome], [apelido]) VALU"& _ 
                "ES (@Username, @password, @nome, @apelido);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Username, password, nome"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Utilizadores] SET [Username] = @Username, [password] = @password, ["& _ 
                "nome] = @nome, [apelido] = @apelido WHERE (([Id] = @Original_Id) AND ([Username]"& _ 
                " = @Original_Username) AND ([password] = @Original_password) AND ([nome] = @Orig"& _ 
                "inal_nome) AND ([apelido] = @Original_apelido));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Username, password,"& _ 
                " nome, apelido FROM Utilizadores WHERE (Id = @Id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Login_For_a_button.My.MySettings.Default.UsersConnectionString
        End Sub
        ...
        Public Overloads Overridable Function Update(ByVal Username As String, ByVal password As String, ByVal nome As String, ByVal apelido As String, ByVal Original_Id As Integer, ByVal Original_Username As String, ByVal Original_password As String, ByVal Original_nome As String, ByVal Original_apelido As String, ByVal Id As Integer) As Integer
            If (Username Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Username")
            Else
        ...
        Public Overloads Overridable Function Update(ByVal Username As String, ByVal password As String, ByVal nome As String, ByVal apelido As String, ByVal Original_Id As Integer, ByVal Original_Username As String, ByVal Original_password As String, ByVal Original_nome As String, ByVal Original_apelido As String) As Integer
            Return Me.Update(Username, password, nome, apelido, Original_Id, Original_Username, Original_password, Original_nome, Original_apelido, Original_Id)
        End Function
    End Class
